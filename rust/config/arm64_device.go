...
func (t *toolchainArm64) ToolchainLinkFlags(ctx android.PathGlobContext) cc_config.FlagsWithDeps {
...
func (t *toolchainArm64) ToolchainRustFlags(ctx android.PathGlobContext) cc_config.FlagsWithDeps {
