...
func TestSeparateAnnotations(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			annotationPrefix:   "includes-annotation",
		...
		},
		{
			...
			annotationPrefix:   "includes-annotation",
			wantFilters:        []string{},
			wantAnnotationArgs: []string{"includes-annotation=annotation1", "includes-annotation=annotation2"},
		},
		{
		...
		},
		{
			...
			annotationPrefix:   "excludes-annotation",
			wantFilters:        []string{},
			wantAnnotationArgs: []string{"excludes-annotation=annotation1"},
		},
	}
		...
		Tests: []*protos.ModulePlan{
			{
				...
				ModuleArgs: []*protos.KeyValue{
					{Key: "arg1", Value: "val1"},
					{Key: "includes-annotation", Value: "annotation1"},
					{Key: "excludes-annotation", Value: "annotation2"},
				},
			},
		},
